namespace batzen
{
    ...
    public class Acl
    {
        ...
        public Zen<bool> dProcess(Zen<Packet> pkt,Device device,Device neiDevice)
        {
            return Process(pkt.GetIpHeader(),0);
        }
        ...
        public Zen<bool> Process(Zen<Ipv4Header> hdr, int i)
        {
        ...
        /// <param name="hdr">The header.</param>
        /// <returns>Whether permitted.</returns>
        public Zen<(bool, ushort)> ProcessProvenance(Zen<Ipv4Header> hdr)
        {
        ...
        /// <param name="i">The line number.</param>
        /// <returns>Whether permitted.</returns>
        public Zen<(bool, ushort)> ProcessProvenance(Zen<Ipv4Header> hdr, int i)
        {
            if (i == this.Lines.Length)
            {
